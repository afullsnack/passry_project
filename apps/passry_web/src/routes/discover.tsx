  ...
  head: () => ({
    meta: [
      ...seo({
        ...
        description: 'Explore upcoming events and discover new experiences.',
      }),
    ],
  }),
  ...
  validateSearch: z.object({
    ...
    filter: z
      .object({
        ...
        order: z.enum(['id', 'title', 'location', 'price']).default('id'),
      })
      .optional(),
  }),
})
...
function RouteComponent() {
  const { q, filter } = useSearch({ from: '/discover' })
  console.log('Search and filter params', q, filter)
